...
Route::group(['prefix' => 'lophoc'], function () {
    ...
    Route::get('/createcopy', 'QlsvLophocController@createcopy')->name('qlsvlophoc.createcopy');
    Route::post('/storecopy', 'QlsvLophocController@storecopy')->name('qlsvlophoc.storecopy');
});
...
Route::group(['prefix' => 'tudanhgia'], function () {
    Route::get('/mon/{id}', 'QlsvTudanhgiaController@mon')->name('qlsv_tudanhgia.mon');
    Route::get('/create/{id}', 'QlsvTudanhgiaController@create')->name('qlsv_tudanhgia.create');
    ...
    Route::post('/update{id}', 'QlsvTudanhgiaController@update')->name('qlsv_tudanhgia.update');
    Route::get('/delete/{id}', 'QlsvTudanhgiaController@destroy')->name('qlsv_tudanhgia.delete');
});
...
Route::group(['prefix' => 'giang_vien'], function () {
    ...
    Route::get('createGiangVien', 'GiangVien\ManhinhGiangvienController@createGiangVien')->name('giang_vien.createGiangVien');
    ...
    Route::get('createGiangVienSinhVien', 'GiangVien\ManhinhGiangvienController@createGiangVienSinhVien')->name('giang_vien.createGiangVienSinhVien');
    Route::post('storeGiangVienSinhVien', 'GiangVien\ManhinhGiangvienController@storeGiangVienSinhVien')->name('giang_vien.storeGiangVienSinhVien');
  
    Route::get('createGiangVienSinhVienLop', 'GiangVien\ManhinhGiangvienController@createGiangVienSinhVienLop')->name('giang_vien.createGiangVienSinhVienLop');
    Route::get('/search', 'GiangVien\ManhinhGiangvienController@search')->name('giang_vien.search');
    ...
    Route::get("/viewxinnghilop", 'GiangVien\ManhinhGiangvienController@viewxinnghilop')->name("giang_vien.viewxinnghilop");
...
Route::group(['prefix' => 'sinh_vien'], function () {
    ...
    Route::get("/viewlichhoc", 'SinhVien\ManhinhSinhvienController@viewlichhoc')->name("sinh_vien.viewlichhoc");
...
Route::group(['prefix' => 'quan_tri'], function () {
    ...
    Route::get("/viewdiemdanhsinhvien", 'QuanTri\ManhinhQuantriController@viewdiemdanhsinhvien')->name("quan_tri.viewdiemdanhsinhvien");
   
    Route::get("/viewdanhgiasinhvien", 'QuanTri\ManhinhQuantriController@viewdanhgiasinhvien')->name("quan_tri.viewdanhgiasinhvien");
    Route::get("/viewxinnghisinhvien", 'QuanTri\ManhinhQuantriController@viewxinnghisinhvien')->name("quan_tri.viewxinnghisinhvien");
