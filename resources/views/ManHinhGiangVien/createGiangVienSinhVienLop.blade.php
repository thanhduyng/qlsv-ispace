            ...
            <tr>
                ...
                <td width=100%>
                    ...
                    <ul style="list-style: none; margin-top: 30px; margin-left: -17px; ">
                        <li style="float: left; margin-right: 3px; "><a class="btn-sm btn-success" style="padding: 8px 18px; font-size: 15px;" href="/giang_vien/createGiangVienSinhVien/?id_lophoc={{$value->id}}">Tạo thông báo</a></li>
