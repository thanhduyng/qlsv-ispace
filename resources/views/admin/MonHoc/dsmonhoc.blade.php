        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    {{$mh->tenmonhoc}}<br>
                    <i>{{$mh->ghichu}}</i><br>
                    <i><a class="btn btn-success px-4 float-right" href="{{route('qlsv_worktask.mon',$mh->id)}}">Work task</a></i>
                    <i><a class="btn btn-success px-4 float-right" href="{{route('qlsv_tudanhgia.mon',$mh->id)}}">Đánh giá</a></i>
                </td>
