    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="width">
                    <i style="margin-left: 2px; font-weight: bold;">Ngày: {{$cl->ngayhoc}}</i><br>
                    @if($cl->id_phonghoc = null)
                    <i style="margin-left: 2px;"><?php echo \App\qlsv_phonghoc::find($cl->id_phonghoc)->tenphonghoc ?></i><br>
                    @endif
                    <i style="margin-left: 2px;"><?php echo \App\qlsv_lophoc::find($cl->id_lophoc)->tenlophoc ?></i><br>
                </td>
