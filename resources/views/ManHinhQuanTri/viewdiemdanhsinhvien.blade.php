...
<main style=" margin-bottom: 200px;">
    <form action="" method="post">
        ...
        @foreach($coPhep as $values)
        <a style="color: black; margin-left: 260px; font-size: 16px; font-weight: bold;">Phép:</a><a style="color: gray; font-weight: bold; font-size: 18px;"> {{$values->cophep}}</a>
        @endforeach
